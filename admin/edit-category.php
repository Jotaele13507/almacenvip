...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		$id = intval($_GET['id']);
		$sql = mysqli_query($con, "update category set categoryCode= '$code', categoryName='$category',categoryDescription='$description',updationDate='$currentTime' where id='$id'");
									...
									<form class="form-horizontal row-fluid" name="Category" method="post">
										...
										?>
											<div class="control-group">
												<label class="control-label" for="basicinput">Código de categoría</label>
												<div class="controls">
													<input type="text" placeholder="Ingrese código de categoría" name="code" value="<?php echo  htmlentities($row['categoryCode']); ?>" class="span8 tip" required>
												</div>
											</div>
