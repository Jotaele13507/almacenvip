...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		$sql = mysqli_query($con, "insert into category(categoryCode,categoryName,categoryDescription) values('$code','$category','$description')");
								...
								<div class="module-body">
									...
									<form class="form-horizontal row-fluid" name="Category" method="post">
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" placeholder="Ingrese código de categoría" name="code" class="span8 tip" required>
											</div>
										</div>
								...
								<div class="module-body table">
									<table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="100%">
										...
										<tbody>
											...
											?>
												<tr>
													<td><?php echo htmlentities($row['categoryCode']); ?></td>
