								...
								<div class="module-body table">
									...
									<table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="100%">
										...
										<tbody>
											...
											<?php $query = mysqli_query($con, "select products.*,category.categoryName,unit.unitType from products join category on category.id=products.category join unit on unit.id = products.unit");
											$cnt = 1;
											...
											?>
												<tr>
													...
													<td>$.<?php echo htmlentities($row['productAvailability'] * $row['productPrice']); ?></td>
